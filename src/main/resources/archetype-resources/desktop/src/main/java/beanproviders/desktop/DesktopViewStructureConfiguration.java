 ...
 */
@BeansProvider
public class DesktopViewStructureConfiguration {

  /**
   * Constructor
   */
  public DesktopViewStructureConfiguration() {
  }
  ...
  public Properties platformProperties() {
    ...
    platformProperties.setProperty("applicationWindowName", "Desktop Quick Start");
    platformProperties.setProperty("applicationTitle", "Desktop Quick Start");
    platformProperties.setProperty("fullScreen", "false");
    platformProperties.setProperty("platformRootStructureId", "GetStartedRSView");
  ...
  public IStylesheetManager styleSheetManager() {
    ...
    sheetsManager.getStyleSheetsPath().add("classpath:/css/color/accent/lime.css");
  ...
  public List<String> SearchablePrimaryHeaderToolbarResponsiveMatrixDefinition(){
    ...
    matrix.add("0:800${symbol_pound}0.5:fixed|500:0.5${symbol_pound}::");
    matrix.add("800:1000${symbol_pound}0.50:fixed|500:0.50${symbol_pound}::");
    matrix.add("1000:1100${symbol_pound}0.50:fixed|600:0.50${symbol_pound}::");
    matrix.add("1100${symbol_pound}0.50:fixed|700:0.50${symbol_pound}::");
    return matrix;
  }
}
